...
// SrmDashboard: Main dashboard page for SRM users
      ...
      <div className="mainInternalPages" style={{ opacity: loading ? 0.5 : 1 }}>
        <div className="commonTitle" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
            {/* Add 3PM button hidden as requested */}
            {/* <button
            ...
            {/* Test Nav button hidden as requested */}
            {/* <button
              onClick={() => {
                console.log('Debug: Testing navigation to test route');
                navigate('/srm/test-route');
              }}
              style={{
                background: '#007bff',
                color: '#fff',
                          ...
                          <button
                            onClick={() => {
                              try {
                                ...
                                console.log('Navigating to:', `/srm/sku-detail/${row.cm_code}`);
                                console.log('Navigate function:', typeof navigate);
                                console.log('Row data:', row);
                                
                                // Use proper React Router navigation for SRM users
                                const targetUrl = `/srm/sku-detail/${row.cm_code}`;
                                ...
                                window.location.href = `/srm/sku-detail/${row.cm_code}`;
                              }
                            }}
                            style={{
                              display: 'flex',
